...
const Footer = () => {
  ...
  return (
    ...
    <footer className="text-white bg-red-500 body-font">
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
          <Link to="/cosmetics" className="text-gray-400 hover:text-white">Products</Link>
          </li>
          <li>
          {/* <Link to="/skincare" className="text-gray-400 hover:text-white">SkinCare</Link> */}
          </li>
        </nav>
      </div>
      {/* <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
        <li>
            <Link to="/jewelry" className="text-gray-400 hover:text-white">Laptops</Link>
          </li>
          <li>
